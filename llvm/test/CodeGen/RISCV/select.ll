...
; RV32IXQCI-NEXT:    qc.selecteqi a1, 0, a0, a2
...
; RV32IXQCI-NEXT:    andi a1, a1, 1
; RV32IXQCI-NEXT:    xori a2, a0, 43
; RV32IXQCI-NEXT:    qc.selectnei a1, 0, a2, a0
; RV32IXQCI-NEXT:    mv a0, a1
; RV32IXQCI-NEXT:    ret
entry:
 %and = and i8 %cond, 1
...
; RV32IXQCI-NEXT:    qc.selecteqi a2, 0, a0, a1
...
; RV32IXQCI-NEXT:    andi a2, a2, 1
; RV32IXQCI-NEXT:    xor a1, a1, a0
; RV32IXQCI-NEXT:    qc.selectnei a2, 0, a1, a0
; RV32IXQCI-NEXT:    mv a0, a2
; RV32IXQCI-NEXT:    ret
entry:
 %and = and i8 %cond, 1
...
; RV32IXQCI-NEXT:    andi a1, a1, 1
; RV32IXQCI-NEXT:    xori a2, a0, 43
; RV32IXQCI-NEXT:    qc.selecteqi a1, 0, a2, a0
; RV32IXQCI-NEXT:    mv a0, a1
; RV32IXQCI-NEXT:    ret
entry:
 %and = and i8 %cond, 1
...
; RV32IXQCI-NEXT:    andi a1, a1, 1
; RV32IXQCI-NEXT:    xori a2, a0, 43
; RV32IXQCI-NEXT:    qc.selectnei a1, 0, a0, a2
; RV32IXQCI-NEXT:    mv a0, a1
; RV32IXQCI-NEXT:    ret
entry:
 %and = and i8 %cond, 1
...
; RV32IXQCI-NEXT:    andi a2, a2, 1
; RV32IXQCI-NEXT:    xor a1, a1, a0
; RV32IXQCI-NEXT:    qc.selecteqi a2, 0, a1, a0
; RV32IXQCI-NEXT:    mv a0, a2
; RV32IXQCI-NEXT:    ret
entry:
 %and = and i8 %cond, 1
...
; RV32IXQCI-NEXT:    andi a2, a2, 1
; RV32IXQCI-NEXT:    xor a1, a1, a0
; RV32IXQCI-NEXT:    qc.selectnei a2, 0, a0, a1
; RV32IXQCI-NEXT:    mv a0, a2
; RV32IXQCI-NEXT:    ret
entry:
 %and = and i8 %cond, 1
...
; RV32IXQCI-NEXT:    add a5, a1, a4
; RV32IXQCI-NEXT:    sltu a0, a5, a1
; RV32IXQCI-NEXT:    add a2, a2, a0
; RV32IXQCI-NEXT:    mv a0, a3
; RV32IXQCI-NEXT:    qc.selectnei a0, 0, a4, a5
; RV32IXQCI-NEXT:    qc.selectieqi a3, 0, a2, 0
; RV32IXQCI-NEXT:    mv a1, a3
; RV32IXQCI-NEXT:    ret
  %add = add i64 %x, 58349
