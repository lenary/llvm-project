...
; RUN: llc -mtriple=riscv32 -mattr=+experimental-xqcicm,+experimental-xqcics,+experimental-xqcicli,+short-forward-branch-opt,+short-forward-branch-opt -verify-machineinstrs < %s \
