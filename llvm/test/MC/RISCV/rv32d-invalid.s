...
fld ft1, a0, -200 # CHECK: :[[@LINE]]:14: error: register must be GPR (x0-x31)
fsd ft2, a1, 100 # CHECK: :[[@LINE]]:14: error: register must be GPR (x0-x31)
...
fcvt.wu.d ft2, a1 # CHECK: :[[@LINE]]:11: error: register must be GPR (x0-x31)
