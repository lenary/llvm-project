...
flw ft1, a0, -200 # CHECK: :[[@LINE]]:14: error: register must be GPR (x0-x31)
fsw ft2, a1, 100 # CHECK: :[[@LINE]]:14: error: register must be GPR (x0-x31)
...
fmv.x.w fs7, a2 # CHECK: :[[@LINE]]:9: error: register must be GPR (x0-x31)
