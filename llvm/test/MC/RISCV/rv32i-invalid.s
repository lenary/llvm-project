...
add a1, a2, (a3) # CHECK: :[[@LINE]]:13: error: register must be GPR (x0-x31)
add a1, a2, foo # CHECK: :[[@LINE]]:13: error: register must be GPR (x0-x31)
...
addi t1, %lo(t2), 1 # CHECK: :[[@LINE]]:10: error: register must be GPR (x0-x31)
...
addi foo, sp, 10 # CHECK: :[[@LINE]]:6: error: register must be GPR (x0-x31)
slti a10, a2, 0x20 # CHECK: :[[@LINE]]:6: error: register must be GPR (x0-x31)
slt x32, s0, s0 # CHECK: :[[@LINE]]:5: error: register must be GPR (x0-x31)
...
xori sp, 22, 220 # CHECK: :[[@LINE]]:10: error: register must be GPR (x0-x31)
sub t0, t2, 1 # CHECK: :[[@LINE]]:13: error: register must be GPR (x0-x31)
...
addi a2, ft0, 24 # CHECK: :[[@LINE]]:10: error: register must be GPR (x0-x31)
